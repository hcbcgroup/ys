...
const Header: React.FC = () => {
  ...
  return (
    <React.Fragment>
      ...
      <header className="w-full fixed top-0 z-40 bg-gradient-to-r from-backgrounderBold to-backgrounder md:bg-transparent backdrop-blur-sm shadow-lg md:shadow-none">
