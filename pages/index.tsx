      ...
      >
        <React.Fragment>
          ...
          <article className="absolute bg-slate-100/60 right-0 top-0 w-12 h-12 animate-spin rounded-xl" /> */}
            <article className="w-full mx-auto  grid grid-cols-1 lg:grid-cols-3 gap-8 backdrop-blur-lg bg-zinc-900/50 rounded-xl shadow-2xl border border-backgrounderBold p-8 md:p-12 transition-all">
              <div className="lg:col-span-1 h-full flex flex-col justify-center">
                <h4 className="text-3xl font-bold mb-4 text-texter/90">
                  Facebook Feed
                </h4>
                <Facebook className="w-full h-full max-w-screen overflow-x-auto bg-white rounded-xl border-8 border-white shadow-2xl shadow-black" />
              </div>
              <div className="w-full text-texter/75 lg:col-span-2">
                <h4 className="text-3xl font-bold mb-4 text-texter/90">
                  Our Location
                </h4>
                ...
                <Map className="w-full max-w-screen overflow-x-auto bg-white rounded-xl border-8 border-white shadow-2xl shadow-black" />
              </div>
              <div className="text-texter/75 lg:col-span-1">
                <h4 className="text-3xl font-bold mb-4 text-texter/90">
                  Open Hours
                </h4>
                <p className="italic mb-8">
                  Holiday business hours are subject to change.
                </p>
                <article></article>
              </div>
            </article>
